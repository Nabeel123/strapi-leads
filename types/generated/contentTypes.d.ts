...
export interface ApiCapabilitiesCapabilities extends Struct.SingleTypeSchema {
  ...
  attributes: {
    badge: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Capabilities'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    features: Schema.Attribute.Component<'sections.capability-feature', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEmailModalEmailModal extends Struct.SingleTypeSchema {
  collectionName: 'email_modals';
  info: {
    displayName: 'Email Capture Modal';
    pluralName: 'email-modals';
    singularName: 'email-modal';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    subtitle: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Subscribe to get the latest strategies and insights delivered to your inbox.'>;
    successMessage: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Thanks! Check your inbox for our first email.'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Get Lead Gen Tips'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFinalCtaFinalCta extends Struct.SingleTypeSchema {
  collectionName: 'final_ctas';
  info: {
    displayName: 'Final CTA Section';
    pluralName: 'final-cta-sections';
    singularName: 'final-cta';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    bullets: Schema.Attribute.Component<'sections.cta-bullet', true>;
    bulletsTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<"What We'll Cover:">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGuaranteeGuarantee extends Struct.SingleTypeSchema {
  collectionName: 'guarantees';
  info: {
    displayName: 'Guarantee Section';
    pluralName: 'guarantee-sections';
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'scroll_modal'>;
...
export interface ApiTestimonialsTestimonials extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Component<'sections.testimonial-stat', true>;
    subtitle: Schema.Attribute.Text & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUseCasesUseCases extends Struct.SingleTypeSchema {
  collectionName: 'use_cases';
  info: {
    displayName: 'Use Cases Section';
    pluralName: 'use-cases-sections';
    singularName: 'use-cases';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    cases: Schema.Attribute.Component<'sections.use-case-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaHref: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#audit'>;
    ...
    ctaText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'View Detailed Results'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiWhyChooseWhyChoose extends Struct.SingleTypeSchema {
  ...
  attributes: {
    columnAds: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Paid Ads'>;
    columnAiseen: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'AISEEN'>;
    columnColdCalling: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Cold Calling'>;
    columnReferrals: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Referrals'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rows: Schema.Attribute.Component<'sections.comparison-row', true>;
    subtitle: Schema.Attribute.Text & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::email-modal.email-modal': ApiEmailModalEmailModal;
      'api::final-cta.final-cta': ApiFinalCtaFinalCta;
      ...
      'api::use-cases.use-cases': ApiUseCasesUseCases;
